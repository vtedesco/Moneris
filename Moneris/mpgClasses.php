...
class mpgGlobals
{
    ...
    function mpgGlobals($moneris_res_url)
    {
        $this->Globals['MONERIS_HOST'] = $moneris_res_url;
    }
...
class mpgHttpsPost
{
    ...
    function mpgHttpsPost($store_id, $api_token, $moneris_res_url, $mpgRequestOBJ)
    {
        ...
        $g=new mpgGlobals($moneris_res_url);
        $gArray=$g->getGlobals();
